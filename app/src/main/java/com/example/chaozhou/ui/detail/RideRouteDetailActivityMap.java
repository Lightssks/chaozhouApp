...
import com.example.chaozhou.ui.adapter.RideSegmentListAdapter;
...
public class RideRouteDetailActivityMap extends MapBaseActivity {
    ...
    public static void newInstance(Activity activity, RidePath ridePath){
        Intent intent = new Intent(activity,RideRouteDetailActivityMap.class);
