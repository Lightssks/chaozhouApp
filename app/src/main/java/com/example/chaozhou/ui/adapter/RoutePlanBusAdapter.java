...
import com.example.chaozhou.listener.ItemBusRouteOnClickListener;
...
public class RoutePlanBusAdapter extends RecyclerView.Adapter<RoutePlanBusAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(AndroidApplication.getContext()).inflate(R.layout.item_route_plan_bus,parent,false);
