...
import com.example.chaozhou.ui.adapter.BusSegmentListAdapter;
import com.example.chaozhou.utils.AMapUtil;
import com.example.chaozhou.utils.BusRouteOverlay;
...
public class BusRouteDetailActivityMap extends MapBaseActivity implements AMap.OnMapLoadedListener,AMap.OnMapClickListener
                ,AMap.InfoWindowAdapter,AMap.OnInfoWindowClickListener,AMap.OnMarkerClickListener{
    private static final String TAG = BusRouteDetailActivityMap.class.getName();
    ...
    public static void newInstance(Activity activity, BusPath busPath, BusRouteResult busRouteResult){
        Intent intent = new Intent(activity,BusRouteDetailActivityMap.class);
    ...
    public void initView(Bundle savedInstanceState) {
        ...
        mBusSegmentListAdapter = new BusSegmentListAdapter(AndroidApplication.getContext(),mBuspath.getSteps());
        ...
        mToolbar.setOnMenuItemClickListener(new Toolbar.OnMenuItemClickListener() {
            ...
            public boolean onMenuItemClick(MenuItem item) {
                if (item.getItemId() == R.id.mapview && !isClicked){
                    ...
                    mMap.clear();
                    mBusrouteOverlay = new BusRouteOverlay(BusRouteDetailActivityMap.this,mMap,mBuspath,mBusRouteResult.getStartPos(),mBusRouteResult.getTargetPos());
