...
import com.example.chaozhou.listener.SearchItemOnClickListener;
...
public class SearchResultAdapter extends RecyclerView.Adapter<SearchResultAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(AndroidApplication.getContext()).inflate(R.layout.item_search_result,parent,false);
