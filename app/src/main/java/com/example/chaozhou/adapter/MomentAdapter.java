...
import com.example.chaozhou.module.comment.CommentFun;
import com.example.chaozhou.module.comment.CustomTagHandler;
...
public class MomentAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            if (position == 0) {
                convertView = View.inflate(mContext, R.layout.comment_item_header, null);
            } else {
                convertView = View.inflate(mContext, R.layout.comment_item_monent, null);
