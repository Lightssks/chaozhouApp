...
public class Dp2Sp2PxUtil {
    ...
    public static int px2dip( float pxValue) {
        ...
        final float scale = AndroidApplication.getContext().getResources().getDisplayMetrics().density;
    ...
    public static int px2sp(  float pxValue) {
        ...
        final float fontScale = AndroidApplication.getContext().getResources().getDisplayMetrics().scaledDensity;
    ...
    public static int dp2px(  int dp) {
        return (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, AndroidApplication.getContext().getResources().getDisplayMetrics());
    }
}
